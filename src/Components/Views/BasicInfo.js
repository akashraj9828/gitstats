            ...
            <div className="card p-4 rounded">
                <div className="row">
                        ...
                        <div className="user-details pl-2">
                            ...
                            {userInfo.websiteUrl && (
                                <p className="font-size-13 mb-1">
                                    ...
                                    <a
                                        className="text-dark hover-white"
                                        href={userInfo.websiteUrl.indexOf("://") === -1 ? "http://" + userInfo.websiteUrl : userInfo.websiteUrl}
                                        target="_blank"
                    ...
                    <div className="col-md-5 mt-4 mt-lg-0 mt-sm-0 following-area">
                        <div className="row">
                            <div className="col-4">
                                <p className="text-center m-0">{userInfo.followers.totalCount}</p>
                                <span>Followers</span>
                            </div>
                            <div className="col-4">
                                <p className="text-center m-0">{userInfo.following.totalCount}</p>
                                <span>Following</span>
                            </div>

                            <div className="col-4">
                                <p className="text-center m-0">{userInfo.repositories.totalCount}</p>
                        ...
                        <div className="row pt-3">
                            <div className="col-4">
                                <p className="text-center m-0">{calculateData.totalCommit ? calculateData.totalCommit : Loader.text_loading}</p>
                                <span>Commits</span>
                            </div>
                            <div className="col-4">
                                <p className="text-center m-0">{calculateData.totalStar ? calculateData.totalStar : Loader.text_loading}</p>
                                <span>Stars</span>
                            </div>

                            <div className="col-4">
                                <p className="text-center m-0">{calculateData.totalFork ? calculateData.totalFork : Loader.text_loading}</p>
                                <span>Forks</span>
                            </div>
                        </div>
                    </div>
