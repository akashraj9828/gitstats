...
try {
  if (window.location.hostname === "gitstats.me" || window.location.hostname.endsWith("vercel.app") || window.location.hostname === "localhost") {
    // Use relative /api for same-domain API proxying (Vercel or localhost)
    API_BASE_URL = "http://localhost:5000/api/";
  } else if (window.location.hostname === "gitstats.me") {
